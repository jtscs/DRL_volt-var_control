...
class CigrePPEnv(py_environment.PyEnvironment):
  ...
  def _step(self, action):
    ...
    #print(f"{self._name} action {action} ")
  ...
  def createAndRunNetSimulation(self, action):
    ...
    for generator in self.net.sgen.name:
      ...
      self.net.sgen['p_mw'][generator_counter] = math.cos(math.radians(action[generator_counter]*51.68-25.84)) * self.net.sgen['sn_mva'][generator_counter]
      self.net.sgen['q_mvar'][generator_counter] = math.sin(math.radians(action[generator_counter]*51.68-25.84)) * self.net.sgen['sn_mva'][generator_counter]
      generator_counter += 1
